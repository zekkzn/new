...
static_assert(alignof(ABP_Light03_C) == 0x000008, "Wrong alignment on ABP_Light03_C");
static_assert(sizeof(ABP_Light03_C) == 0x0002B0, "Wrong size on ABP_Light03_C");
static_assert(offsetof(ABP_Light03_C, SpotLight) == 0x0002A0, "Member 'ABP_Light03_C::SpotLight' has a wrong offset!");
static_assert(offsetof(ABP_Light03_C, SM_Lamp01) == 0x0002A8, "Member 'ABP_Light03_C::SM_Lamp01' has a wrong offset!");

...
public:
	struct FRetargetProfile                       RetargetProfile;                                   // 0x0000(0x0110)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FTargetChainSettings                   Param_ChainSettings;                               // 0x0110(0x00B0)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(IKRetargeter_SetChainSettingsInRetargetProfile, Param_ChainSettings) == 0x000110, "Member 'IKRetargeter_SetChainSettingsInRetargetProfile::Param_ChainSettings' has a wrong offset!");
...
public:
	struct FRetargetProfile                       RetargetProfile;                                   // 0x0000(0x0110)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FRetargetGlobalSettings                Param_GlobalSettings;                              // 0x0110(0x0024)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_134[0x4];                                      // 0x0134(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(IKRetargeter_SetGlobalSettingsInRetargetProfile, Param_GlobalSettings) == 0x000110, "Member 'IKRetargeter_SetGlobalSettingsInRetargetProfile::Param_GlobalSettings' has a wrong offset!");
...
public:
	struct FRetargetProfile                       RetargetProfile;                                   // 0x0000(0x0110)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FTargetRootSettings                    Param_RootSettings;                                // 0x0110(0x0068)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(IKRetargeter_SetRootSettingsInRetargetProfile, Param_RootSettings) == 0x000110, "Member 'IKRetargeter_SetRootSettingsInRetargetProfile::Param_RootSettings' has a wrong offset!");

...
static_assert(alignof(UWBP_CoreInputPrompt_PressButton_C) == 0x000008, "Wrong alignment on UWBP_CoreInputPrompt_PressButton_C");
static_assert(sizeof(UWBP_CoreInputPrompt_PressButton_C) == 0x0003E0, "Wrong size on UWBP_CoreInputPrompt_PressButton_C");
static_assert(offsetof(UWBP_CoreInputPrompt_PressButton_C, UberGraphFrame) == 0x0003D8, "Member 'UWBP_CoreInputPrompt_PressButton_C::UberGraphFrame' has a wrong offset!");

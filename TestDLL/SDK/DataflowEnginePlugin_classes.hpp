...
{
public:
	uint8                                         Pad_590[0x140];                                    // 0x0590(0x0140)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDataflowComponent) == 0x0006D0, "Wrong size on UDataflowComponent");

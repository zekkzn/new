...
public:
	...
	uint8                                         Pad_5A9[0xF];                                      // 0x05A9(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bDisplayDeviceModel;                               // 0x05B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5B9[0x3];                                      // 0x05B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   DisplayModelSource;                                // 0x05BC(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UPrimitiveComponent*                    DisplayComponent;                                  // 0x05E0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5E8[0xF8];                                     // 0x05E8(0x00F8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMotionControllerComponent, PlayerIndex) == 0x000590, "Member 'UMotionControllerComponent::PlayerIndex' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, Hand) == 0x000594, "Member 'UMotionControllerComponent::Hand' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, MotionSource) == 0x000598, "Member 'UMotionControllerComponent::MotionSource' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, CurrentTrackingStatus) == 0x0005A8, "Member 'UMotionControllerComponent::CurrentTrackingStatus' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, bDisplayDeviceModel) == 0x0005B8, "Member 'UMotionControllerComponent::bDisplayDeviceModel' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, DisplayModelSource) == 0x0005BC, "Member 'UMotionControllerComponent::DisplayModelSource' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, CustomDisplayMesh) == 0x0005C8, "Member 'UMotionControllerComponent::CustomDisplayMesh' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, DisplayMeshMaterialOverrides) == 0x0005D0, "Member 'UMotionControllerComponent::DisplayMeshMaterialOverrides' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, DisplayComponent) == 0x0005E0, "Member 'UMotionControllerComponent::DisplayComponent' has a wrong offset!");
...
{
public:
	bool                                          bIsVisualizationActive;                            // 0x0678(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_679[0x3];                                      // 0x0679(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   DisplayModelSource;                                // 0x067C(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UStaticMesh*                            CustomDisplayMesh;                                 // 0x0688(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UMaterialInterface*>             DisplayMeshMaterialOverrides;                      // 0x0690(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UXRDeviceVisualizationComponent) == 0x0006D0, "Wrong size on UXRDeviceVisualizationComponent");
static_assert(offsetof(UXRDeviceVisualizationComponent, bIsVisualizationActive) == 0x000678, "Member 'UXRDeviceVisualizationComponent::bIsVisualizationActive' has a wrong offset!");
static_assert(offsetof(UXRDeviceVisualizationComponent, DisplayModelSource) == 0x00067C, "Member 'UXRDeviceVisualizationComponent::DisplayModelSource' has a wrong offset!");
static_assert(offsetof(UXRDeviceVisualizationComponent, CustomDisplayMesh) == 0x000688, "Member 'UXRDeviceVisualizationComponent::CustomDisplayMesh' has a wrong offset!");
static_assert(offsetof(UXRDeviceVisualizationComponent, DisplayMeshMaterialOverrides) == 0x000690, "Member 'UXRDeviceVisualizationComponent::DisplayMeshMaterialOverrides' has a wrong offset!");

...
public:
	...
	class UMaterialInterface*                     DefaultMeshMaterial;                               // 0x0308(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     DefaultWireframeMeshMaterial;                      // 0x0310(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMRMeshComponent*                       MRMeshComponent;                                   // 0x0318(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UARTrackedGeometry*                     MyTrackedGeometry;                                 // 0x0320(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARComponent) == 0x000340, "Wrong size on UARComponent");
static_assert(offsetof(UARComponent, NativeID) == 0x0002C0, "Member 'UARComponent::NativeID' has a wrong offset!");
static_assert(offsetof(UARComponent, bUseDefaultReplication) == 0x000300, "Member 'UARComponent::bUseDefaultReplication' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultMeshMaterial) == 0x000308, "Member 'UARComponent::DefaultMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultWireframeMeshMaterial) == 0x000310, "Member 'UARComponent::DefaultWireframeMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, MRMeshComponent) == 0x000318, "Member 'UARComponent::MRMeshComponent' has a wrong offset!");
static_assert(offsetof(UARComponent, MyTrackedGeometry) == 0x000320, "Member 'UARComponent::MyTrackedGeometry' has a wrong offset!");
...
static_assert(sizeof(UARPlaneComponent) == 0x000410, "Wrong size on UARPlaneComponent");
static_assert(offsetof(UARPlaneComponent, ReplicatedPayload) == 0x000340, "Member 'UARPlaneComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARPointComponent) == 0x000350, "Wrong size on UARPointComponent");
static_assert(offsetof(UARPointComponent, ReplicatedPayload) == 0x000340, "Member 'UARPointComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARFaceComponent) == 0x0003D0, "Wrong size on UARFaceComponent");
static_assert(offsetof(UARFaceComponent, TransformSetting) == 0x000340, "Member 'UARFaceComponent::TransformSetting' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bUpdateVertexNormal) == 0x000341, "Member 'UARFaceComponent::bUpdateVertexNormal' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bFaceOutOfScreen) == 0x000342, "Member 'UARFaceComponent::bFaceOutOfScreen' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, ReplicatedPayload) == 0x000348, "Member 'UARFaceComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARImageComponent) == 0x0003E0, "Wrong size on UARImageComponent");
static_assert(offsetof(UARImageComponent, ReplicatedPayload) == 0x000340, "Member 'UARImageComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARQRCodeComponent) == 0x0003F0, "Wrong size on UARQRCodeComponent");
static_assert(offsetof(UARQRCodeComponent, ReplicatedPayload) == 0x000340, "Member 'UARQRCodeComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARPoseComponent) == 0x0003B0, "Wrong size on UARPoseComponent");
static_assert(offsetof(UARPoseComponent, ReplicatedPayload) == 0x000340, "Member 'UARPoseComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UAREnvironmentProbeComponent) == 0x0003A0, "Wrong size on UAREnvironmentProbeComponent");
static_assert(offsetof(UAREnvironmentProbeComponent, ReplicatedPayload) == 0x000340, "Member 'UAREnvironmentProbeComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(offsetof(UARObjectComponent, ReplicatedPayload) == 0x000340, "Member 'UARObjectComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(offsetof(UARMeshComponent, ReplicatedPayload) == 0x000340, "Member 'UARMeshComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARGeoAnchorComponent) == 0x0003E0, "Wrong size on UARGeoAnchorComponent");
static_assert(offsetof(UARGeoAnchorComponent, ReplicatedPayload) == 0x000340, "Member 'UARGeoAnchorComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnARActorSpawnedDelegate;                          // 0x02C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnARActorToBeDestroyedDelegate;                    // 0x02D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UARLifeCycleComponent) == 0x0002F0, "Wrong size on UARLifeCycleComponent");
static_assert(offsetof(UARLifeCycleComponent, OnARActorSpawnedDelegate) == 0x0002C0, "Member 'UARLifeCycleComponent::OnARActorSpawnedDelegate' has a wrong offset!");
static_assert(offsetof(UARLifeCycleComponent, OnARActorToBeDestroyedDelegate) == 0x0002D0, "Member 'UARLifeCycleComponent::OnARActorToBeDestroyedDelegate' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnARTrackingStateChanged;                          // 0x0128(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnARTransformUpdated;                              // 0x0138(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)

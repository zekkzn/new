...
public:
	...
	uint8                                         bAutoRegisterWithBudgetAllocator : 1;              // 0x10C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoCalculateSignificance : 1;                    // 0x10C0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bShouldUseActorRenderedFlag : 1;                   // 0x10C0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_10C1[0xF];                                     // 0x10C1(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USkeletalMeshComponentBudgeted) == 0x0010D0, "Wrong size on USkeletalMeshComponentBudgeted");
